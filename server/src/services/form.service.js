...
const financingSchema = z.object({
  ...
  years_in_business: z.string().trim().optional().default(""),
  yearly_revenue: z.string().trim().optional().default(""),
  financing_solution_type: z.string().trim().optional().default(""),
  loan_amount: z.string().trim().optional().default(""),
  loan_purpose: z.string().trim().optional().default(""),
  equipment_manufacturer: z.string().trim().optional().default(""),
  equipment_model: z.string().trim().optional().default(""),
  equipment_year: z.string().trim().optional().default(""),
