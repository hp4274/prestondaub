-- phpMyAdmin SQL Dump
-- Preston Daub - Database Schema & Initial Data
--
...
--
INSERT INTO `admins` (`id`, `email`, `password`, `password_hash`, `name`, `role`, `created_at`, `updated_at`) VALUES
(1, 'rumit@prestondaub.com', '$2y$10$xqVp8gLK7LoH9Jw60LtD0uW9m8LJiYIt1WWD.i3VMTB/PdS7CB9V2', '$2y$10$xqVp8gLK7LoH9Jw60LtD0uW9m8LJiYIt1WWD.i3VMTB/PdS7CB9V2', 'Drew Cisel', 'admin', '2026-02-25 02:47:41', '2026-03-02 18:59:46'),
(2, 'andrew.cisel@gmail.com', '$2y$10$lB3Q0p9Ejbl2Mi0flIVTYOIa.nXVVGTRAbLTCIXrsTIMXpR7Kdxr.', '$2y$10$lB3Q0p9Ejbl2Mi0flIVTYOIa.nXVVGTRAbLTCIXrsTIMXpR7Kdxr.', 'Andrew Cisel', 'admin', '2026-03-01 12:11:04', '2026-03-01 12:11:04'),
(3, 'rumit@keryar.com', '$2y$10$UGJMtJJFzXo/GUgckEljn.UEGhOLGSONCLQeBS//.3MHwcxV7LXVC', '$2y$10$UGJMtJJFzXo/GUgckEljn.UEGhOLGSONCLQeBS//.3MHwcxV7LXVC', 'Rumit', 'restricted', '2026-03-01 12:11:04', '2026-03-01 12:11:04'),
(4, 'harshlpatel.4274@gmail.com', '$2y$12$CXGam3BkkhHFrjPMZ6gjpeE19.M/QVFpTkFCcyMd0Q5xOBa2TC4gG', '$2y$12$CXGam3BkkhHFrjPMZ6gjpeE19.M/QVFpTkFCcyMd0Q5xOBa2TC4gG', 'Harsh Patel', 'admin', '2026-07-09 12:50:37', '2026-07-09 12:50:37');
...
--
-- Table structure for table `financing_submissions`
--
CREATE TABLE `financing_submissions` (
  ...
  `form_subtype` varchar(50) DEFAULT NULL,
  `ip_address` varchar(45) DEFAULT NULL,
  `user_agent` varchar(500) DEFAULT NULL,
  `status` varchar(50) DEFAULT 'new',
  `priority` varchar(50) DEFAULT 'low',
...
--
-- Table structure for table `mosaic_submissions`
--
CREATE TABLE `mosaic_submissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phone` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `prospera_submissions`
--
CREATE TABLE `prospera_submissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `first_name` varchar(255) NOT NULL,
  `last_name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
...
(1, 'admin_email', 'notifications@prestondaub.com', '2026-02-25 02:49:41'),
(2, 'site_name', 'Preston Daub', '2026-02-25 02:49:41'),
(3, 'maintenance_mode', '0', '2026-02-25 02:49:41'),
...
--
INSERT INTO `team_members` (`id`, `name`, `designation`, `bio`, `photo_url`, `email`, `display_order`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Rahul Mehta', 'Chief Executive Officer', 'Visionary leader with 12+ years of experience in business growth and strategic expansion.', NULL, NULL, 1, 'active', '2026-02-28 15:57:31', '2026-02-28 18:18:43'),
(2, 'Priya Shah', 'Head of Operations', 'Expert in operational efficiency and team management with a strong analytical background.', NULL, NULL, 2, 'active', '2026-02-28 15:57:31', '2026-02-28 18:18:41'),
(3, 'Arjun Patel', 'Senior Software Architect', 'Specializes in scalable system architecture and enterprise solutions.', NULL, NULL, 3, 'active', '2026-02-28 15:57:31', '2026-02-28 17:37:41'),
(4, 'Neha Desai', 'Marketing Director', 'Focused on brand strategy, digital marketing, and growth campaigns.', NULL, NULL, 4, 'active', '2026-02-28 15:57:31', '2026-02-28 18:18:46');

--
-- Constraints for table `news`
--
ALTER TABLE `news`
  ADD CONSTRAINT `news_ibfk_1` FOREIGN KEY (`author`) REFERENCES `admins` (`id`) ON DELETE SET NULL;
