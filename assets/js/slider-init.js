...
(function ($) {
  ...
  ////////////////////////////////////////////////////
  // 08. tp-portfolio-showcase-slide-active
  let t7_showcase_slide_active = new Swiper(
  ...
  var service_cst = new Swiper(".tp-service-cst-slider", {
    slidesPerView: 6,
    loop: true,
    // enable autoplay to auto-rotate slides (matches data-swiper-options in HTML)
  ...
  ////////////////////////////////////////////////////
  // 19. tp-testimonial-ai-slide-active
  let tp_testimonial_ai_slide_active = new Swiper(
  ...
  ////////////////////////////////////////////////////
  // 21. tp-testimonial-md-slide-active
  let tp_testimonial_md_slide_active = new Swiper(
  ...
  let tp_portfolio_horizontal_active = new Swiper(
  ...
  ////////////////////////////////////////////////////
  // 25. tp-portfolio-creative-slider-active
  var SwiperSliderFourteen = new Swiper(
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".coverflow-slider-main").forEach((el) => {
      ...
      document
        .querySelectorAll(".coverflow-slider-text-active")
        .forEach((el) => {
