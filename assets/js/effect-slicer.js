  ...
  return (
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
                ...
                (t, s) => {
                  ...
                  "horizontal" === e.params.direction
                    ? ((t.style.height =
                      ...
                      (t.style.top =
                        (100 / e.params.slicerEffect.split) * s + "%"),
                      (i.style.top = `-${100 * s}%`))
                    : ((t.style.width =
                        100 / e.params.slicerEffect.split + "%"),
                      (t.style.left =
              ...
              i.forEach((s, n) => {
                0 === t
                  ? ((s.style.transitionTimingFunction = "ease-out"),
                    (s.style.transitionDuration = r
                      ? "0ms"
                      : `${e.params.speed + (e.params.speed / (i.length - 1)) * (i.length - n - 1)}ms`))
      ...
      (s("beforeLoopFix", () => {
            ...
            (() => {
              ...
              e.slides.forEach((s, i) => {
                ...
                const r = s.progress,
                  n = s.querySelector(".swiper-slide-content");
                (n &&
                  (n.style.transform = `translate${t}(${e.size * -r * 1.2}px)`),
                  s
        ...
        s("init", () => {
          "slicer" === e.params.effect &&
            (n(), i("setTranslate", e, e.translate));
        }),
        s("resize init", () => {
