      ...
      ((g.uniformName = p[0]),
        3 === p.length
          ? ((g.isStructArray = !0),
            ...
            (g.structProperty = p[2]))
          : 2 === p.length &&
            isNaN(Number(p[1])) &&
            ((g.isStruct = !0), (g.structProperty = p[1])));
    }
...
class Renderer {
  constructor({
    ...
    ((this.dpr = r),
      ...
      this.gl ||
        (this.gl =
          t.getContext("webgl", d) || t.getContext("experimental-webgl", d)),
      ...
      (s.forEach((t) => {
        (t.program.transparent
          ...
          0 === t.renderOrder &&
            t.program.depthTest &&
            e &&
            (t.worldMatrix.getTranslation(tempVec3$1),
...
function slerp(t, e, i, r) {
  ...
  return (
    (d = s * o + n * l + a * u + h * c) < 0 &&
      ((d = -d), (o = -o), (l = -l), (u = -u), (c = -c)),
    1 - d > 1e-6
      ? ((p = Math.sin((1 - r) * _) / (g = Math.sin((_ = Math.acos(d))))),
        (m = Math.sin(r * _) / g))
      : ((p = 1 - r), (m = r)),
    (t[0] = p * s + m * o),
    (t[1] = p * n + m * l),
...
class Quat extends Array {
  ...
  set(t, e, i, r) {
    return t.length
      ? this.copy(t)
      : (set$2(this, t, e, i, r), this.onChange(), this);
  }
  rotateX(t) {
  ...
  multiply(t, e) {
    return (
      e ? multiply$1(this, t, e) : multiply$1(this, this, t),
      this.onChange(),
      this
    );
  }
...
function translate(t, e, i) {
  ...
  return (
    e === t
      ? ((t[12] = e[0] * r + e[4] * s + e[8] * n + e[12]),
        (t[13] = e[1] * r + e[5] * s + e[9] * n + e[13]),
        (t[14] = e[2] * r + e[6] * s + e[10] * n + e[14]),
        (t[15] = e[3] * r + e[7] * s + e[11] * n + e[15]))
      : ((a = e[0]),
        (h = e[1]),
        (o = e[2]),
        (l = e[3]),
...
class Mat4 extends Array {
  ...
  set(t, e, i, r, s, n, a, h, o, l, u, c, _, d, g, p) {
    return t.length
      ? this.copy(t)
      : (set$3(this, t, e, i, r, s, n, a, h, o, l, u, c, _, d, g, p), this);
  }
  translate(t, e = this) {
...
class Camera extends Transform {
  ...
  unproject(t) {
    return (
      t.applyMatrix4(tempMat4.inverse(this.projectionMatrix)),
...
class Mat3 extends Array {
  ...
  set(t, e, i, r, s, n, a, h, o) {
    return t.length
      ? this.copy(t)
      : (set$4(this, t, e, i, r, s, n, a, h, o), this);
  }
  translate(t, e = this) {
  ...
  constructor(
    ...
    for (let f = 0; f < s; f++)
      (this.textures.push(
        ...
        this.gl.framebufferTexture2D(
          this.target,
          this.gl.COLOR_ATTACHMENT0 + f,
          this.gl.TEXTURE_2D,
          this.textures[f].texture,
          0,
        ),
    ...
    ($.length > 1 && this.gl.renderer.drawBuffers($),
      ...
      (this.gl.renderer.isWebgl2 ||
        ...
        ? ((this.depthTexture = new Texture(t, {
            width: e,
            height: i,
...
class Color extends Array {
  constructor(t = 0, e = 0, i = 0) {
    return (
      "string" == typeof t && ([t, e, i] = hexToRGB(t)),
      super(t, e, i),
      this
    );
  }
  ...
  set(t, e, i) {
    return ("string" == typeof t && ([t, e, i] = hexToRGB(t)), t.length)
      ? this.copy(t)
...
class Vec2 extends Array {
  ...
  multiply(t) {
    return (
      t.length ? multiply$4(this, this, t) : scale$3(this, this, t),
      this
    );
  }
  divide(t) {
    return (
      t.length ? divide$1(this, this, t) : scale$3(this, this, 1 / t),
      this
    );
  }
  inverse(t = this) {
    ...
    for (let C = 0; C < u; C++)
      for (let O = 0; O < l; O++) {
        let D = A[C][O + 1],
          ...
          I = A[C + 1][O + 1];
        ((0 !== C || d > 0) &&
          ((v[3 * E] = D), (v[3 * E + 1] = B), (v[3 * E + 2] = I), E++),
          (C !== u - 1 || y < Math.PI) &&
            ((v[3 * E] = B), (v[3 * E + 1] = z), (v[3 * E + 2] = I), E++));
      }
    (Object.assign(o, {
    ...
    function A(t) {
      ...
      for (
        ...
        let o = s / u,
          ...
          c = Math.cos(l),
          g = Math.sin(l);
        ($.set([n * g, 0.5 * r * a, n * c], 3 * b),
          f.set([0, a, 0], 3 * b),
          x.set([0.5 * c + 0.5, 0.5 * g * a + 0.5], 2 * b),
          b++);
      }
      for (s = 0; s < u; s++) {
        let p = h + s + 1;
...
let STATE = { NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, DOLLY_PAN: 3 },
  tempVec3$2 = new Vec3(),
  tempVec2a = new Vec2(),
  tempVec2b = new Vec2();
function Orbit(
  ...
  (w.copy(t.position).sub(this.target),
    ...
    (this.update = () => {
      ((x.radius *= f.radius),
        ...
        (x.radius = Math.max(
          this.minDistance,
          Math.min(this.maxDistance, x.radius),
        )),
        (v.phi += (x.phi - v.phi) * s),
        ...
        switch ((t.preventDefault(), t.touches.length)) {
          ...
          case 2:
            ...
            (!(function t(e) {
              ...
              if (u) {
                let s = 0.5 * (e.touches[0].pageX + e.touches[1].pageX),
...
class Raycast {
    ...
    return (
      t.forEach((t) => {
        ...
        (n =
          ...
          (t.hit || (t.hit = { localPoint: new Vec3() }),
          (t.hit.distance = n),
  ...
  intersectBox(t, e = this.origin, i = this.direction) {
    ...
    (s = ((l >= 0 ? d.x : _.x) - e.x) * l),
    (n = ((u >= 0 ? _.y : d.y) - e.y) * u),
    r > (a = ((u >= 0 ? d.y : _.y) - e.y) * u) || n > s)
      ? 0
      : (n > r && (r = n),
          a < s && (s = a),
          (h = ((c >= 0 ? _.z : d.z) - e.z) * c),
          r > (o = ((c >= 0 ? d.z : _.z) - e.z) * c) || h > s)
        ? 0
        : (h > r && (r = h), o < s && (s = o), s < 0)
          ? 0
          : r >= 0
...
class Post {
  ...
  addPass({
    ...
    let n = new Program(this.gl, { vertex: t, fragment: e, uniforms: i }),
      a = new Mesh(this.gl, { geometry: this.geometry, program: n }),
      h = { mesh: a, program: n, uniforms: i, enabled: s, textureUniform: r };
...
class Skin extends Mesh {
  ...
  addAnimation(t) {
    let e = new Animation({ objects: this.bones, data: t });
...
function Text({
  ...
  function $() {
    ...
    for (let r = 0; r < i; r++)
      ((c.id[r] = r),
        c.index.set(
          [4 * r, 4 * r + 2, 4 * r + 1, 4 * r + 1, 4 * r + 2, 4 * r + 3],
          6 * r,
        ));
    f();
  }
        ...
        for (let _ = 0; _ < i.length; _++) {
          ...
          for (let p = 0; p < d.glyphs.length; p++) {
            ...
            let x = $.width * g,
              v = $.height * g;
            c.position.set(
              [f, o - v, 0, f, o, 0, f + x, o - v, 0, f + x, o, 0],
              12 * u,
            );
            let b = $.x / n,
              w = $.width / n,
...
function NormalProgram(t) {
  return new Program(t, { vertex: vertex, fragment: fragment });
}
class Flowmap {
  constructor(
    t,
...
class Polyline {
  constructor(
    ...
    let _ = (this.geometry = new Geometry(
      t,
      Object.assign(n, {
    ...
    (this.updateGeometry(),
      s.uResolution ||
        (this.resolution = s.uResolution = { value: new Vec2() }),
      s.uDPR || (this.dpr = s.uDPR = { value: 1 }),
      s.uThickness || (this.thickness = s.uThickness = { value: 1 }),
      s.uColor || (this.color = s.uColor = { value: new Color("#000") }),
      s.uMiter || (this.miter = s.uMiter = { value: 1 }),
      this.resize());
    ...
    this.mesh = new Mesh(t, { geometry: _, program: d });
  }
  updateGeometry() {
    (this.points.forEach((t, e) => {
      (t.toArray(this.position, 6 * e),
        ...
        e
          ? (t.toArray(this.next, (e - 1) * 6),
            t.toArray(this.next, (e - 1) * 6 + 3))
          : (tmp
              .copy(t)
              .sub(this.points[e + 1])
              .add(t),
        ...
        e === this.points.length - 1
          ? (tmp
            ...
            tmp.toArray(this.next, 6 * e + 3))
          : (t.toArray(this.prev, (e + 1) * 6),
...
class Shadow {
  constructor(t, { light: e = new Camera(t), width: i = 1024, height: r = i }) {
    ((this.gl = t),
      (this.light = e),
      (this.target = new RenderTarget(t, { width: i, height: r })),
  ...
  add({
    ...
    if (
      (e &&
        !t.program.uniforms[n] &&
        ((t.program.uniforms[n] = { value: this.light.projectionMatrix }),
        (t.program.uniforms[a] = { value: this.light.viewMatrix }),
        (t.program.uniforms[h] = { value: this.target.texture })),
      i &&
    ...
    (t.traverse((t) => {
      t.draw &&
        (~this.castMeshes.indexOf(t)
          ...
          : (t.visible && (t.isForceVisibility = !0), (t.visible = !1)));
    }),
      this.gl.renderer.render({
        scene: t,
        camera: this.light,
      ...
      t.traverse((t) => {
        t.draw &&
          (~this.castMeshes.indexOf(t)
            ...
            : t.isForceVisibility && (t.visible = !0));
      }));
  }
}
let defaultVertex$3 = `
